# Variables for SSM Parameters Module
# This file contains variable definitions only - no sensitive values
...
variable "mongodb_password" {
  description = "MongoDB Atlas password (extracted from connection string)"
  type        = string
  sensitive   = true
}
...
variable "redis_password" {
  description = "Redis/Upstash password (extracted from connection URL)"
  type        = string
  sensitive   = true
}
